...
export default function FlowPage() {
    ...
    return (
        ...
        <div className="dndflow">
            {/* <div className='absolute bg-slate-100 top-13 lg:left-[250px] left-[150px]  z-40 px-2 flex justify-between items-center lg:w-[calc(100%-250px)] w-[calc(100%-150px)] lg:max-w-[950px]  shadow-inner dark:bg-slate-800'>
                <div>
                    {!isRunning
                        ?
                        <button className=''
